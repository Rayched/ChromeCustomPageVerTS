...
### 📆 총 작업 기간: 2023.09.11 ~ 2023.10.19 (약 39일)
---
...
![프로젝트 적용 결과](/SampleImage/ToyProject_Output.png)

- 처음 생각했던 것은 프로젝트를 Github를 통해서 <br/>
  호스팅을 하면서 메인보다는 서브 느낌으로 활용하려고 했다.

- 하지만 실제 Git Page를 통해 호스팅을 시도해보니 <br/>
  내가 의도한 대로 웹 페이지가 동작하지 않는 것을 목격하였다. <br/>

- 오늘 날짜도 안나오고, 검색창도 작동하지 않고 <br/>
  북마크 바도 동작하지 않는 말 그대로 정적인 것만 구현된 느낌이었다. <br/>

- 아직 Git Page에 대해 모르는 것이 너무나도 많기에 <br/>
  왜 이런 결과를 맞이하게 됐는지 파악하지는 못했고 <br/>
  어쩔 수 없이 내가 생각해둔 그림을 지울 수 밖에 없었다.

- 그래도 비록 우여곡절은 많았지만 <br/>
